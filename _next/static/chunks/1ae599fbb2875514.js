(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,98715,e=>{"use strict";var t=e.i(43476),o=e.i(71645),n=e.i(22016),i=e.i(46932);let a={"robots-that-code-better-than-me":{id:1,date:"Jan 15, 2025",title:"Robots That Code Better Than Me",category:"AI & Development",readTime:"3 min read",content:`
      ...
      `},"what-i-got-wrong-this-year":{id:2,date:"Dec 28, 2024",title:"What I Got Wrong This Year",category:"Reflection",readTime:"5 min read",content:`
      ...
      `},"why-every-icon-strategy-fails":{id:3,date:"Nov 12, 2024",title:"Why Every Icon Strategy Fails",category:"Design Systems",readTime:"4 min read",content:`
      ...
      `},"breaking-things-to-learn-them":{id:4,date:"Oct 25, 2024",title:"Breaking Things to Learn Them",category:"Learning",readTime:"6 min read",content:`
      ...
      `},"teaching-spreadsheet-people-to-dream":{id:5,date:"Sep 18, 2024",title:"Teaching Spreadsheet People to Dream",category:"Leadership",readTime:"4 min read",content:`
      ...
      `},"the-internets-best-kept-ai-secrets":{id:6,date:"Aug 14, 2024",title:"The Internet's Best Kept AI Secrets",category:"AI & Tools",readTime:"7 min read",content:`
      ...
      `},"how-i-built-nothing-and-called-it-content":{id:7,date:"Jul 20, 2024",title:"How I Built Nothing and Called It Content",category:"Content Strategy",readTime:"3 min read",content:`
      ...
      `},"click-here-to-edit-reality":{id:8,date:"Jun 8, 2024",title:"Click Here to Edit Reality",category:"Web Development",readTime:"5 min read",content:`
      ...
      `},"why-great-feels-impossible":{id:9,date:"May 15, 2024",title:"Why Great Feels Impossible",category:"Mindset",readTime:"6 min read",content:`
      ...
      `},"hiring-designers-who-actually-design":{id:10,date:"Apr 22, 2024",title:"Hiring Designers Who Actually Design",category:"Hiring & Teams",readTime:"4 min read",content:`
      ...
      `},"from-bio-science-to-bug-fixes":{id:11,date:"Mar 30, 2024",title:"From Bio Science to Bug Fixes",category:"Career Journey",readTime:"5 min read",content:`
      ...
      `},"talks-that-nobody-remembers":{id:12,date:"Feb 14, 2024",title:"Talks That Nobody Remembers",category:"Communication",readTime:"4 min read",content:`
      ...
      `}};e.s(["default",0,({slug:e})=>{let[s,r]=(0,o.useState)(null);return((0,o.useEffect)(()=>{let t=a[e];t&&r(t)},[e]),s)?(0,t.jsx)("div",{className:"min-h-screen bg-dark text-text font-mono",children:(0,t.jsxs)("article",{className:"container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24",children:[(0,t.jsx)(i.motion.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.6},className:"mb-8",children:(0,t.jsx)(n.default,{href:"/thoughts",className:"text-primary hover:text-primary-dark font-grotesk text-sm no-underline inline-flex items-center transition-colors duration-300",children:"← Back to all thoughts"})}),(0,t.jsxs)(i.motion.header,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8},className:"mb-12 text-center max-w-4xl mx-auto",children:[(0,t.jsxs)("div",{className:"flex items-center justify-center gap-4 mb-6 text-sm",children:[(0,t.jsx)("span",{className:"text-primary text-xs font-semibold uppercase tracking-wider px-3 py-1 bg-primary/10 rounded-full border border-primary/20",children:s.category}),(0,t.jsx)("span",{className:"text-text-muted font-mono",children:s.date}),(0,t.jsx)("span",{className:"text-text-muted font-mono",children:s.readTime})]}),(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight font-departure-mono",children:s.title})]}),(0,t.jsx)(i.motion.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.2},className:"prose prose-lg prose-invert max-w-4xl mx-auto",children:(0,t.jsx)("div",{className:"thought-content text-gray-300 leading-relaxed font-grotesk",dangerouslySetInnerHTML:{__html:s.content}})}),(0,t.jsx)(i.motion.footer,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.4},className:"mt-16 pt-8 border-t border-white/10 text-center",children:(0,t.jsxs)("div",{className:"max-w-2xl mx-auto",children:[(0,t.jsx)("h3",{className:"text-xl font-bold text-white mb-4 font-departure-mono",children:"Enjoyed this thought?"}),(0,t.jsx)("p",{className:"text-gray-400 mb-6 font-grotesk",children:"More random musings about code, design, and the occasional existential crisis."}),(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[(0,t.jsx)(n.default,{href:"/thoughts",className:"px-6 py-3 bg-primary text-dark font-semibold rounded-lg transition-all duration-300 hover:bg-primary-dark hover:-translate-y-1 font-grotesk no-underline",children:"Read more thoughts"}),(0,t.jsx)("a",{href:"#contact",className:"px-6 py-3 border-2 border-primary text-primary hover:bg-primary hover:text-dark font-semibold rounded-lg transition-all duration-300 hover:-translate-y-1 font-grotesk no-underline",children:"Get in touch"})]})]})})]})}):(0,t.jsx)("div",{className:"min-h-screen bg-dark text-text font-mono",children:(0,t.jsxs)("div",{className:"container mx-auto px-4 py-24 text-center",children:[(0,t.jsx)("h1",{className:"text-4xl font-bold text-white mb-4 font-departure-mono",children:"Post Not Found"}),(0,t.jsx)("p",{className:"text-gray-400 mb-8 font-grotesk",children:"The thought you're looking for doesn't exist."}),(0,t.jsx)(n.default,{href:"/thoughts",className:"text-primary hover:text-primary-dark font-grotesk no-underline",children:"← Back to all thoughts"})]})})}],98715)}]);