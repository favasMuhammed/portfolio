...
const Hero = () => {
  ...
  const imageTranslateY = isMobile
    ? Math.max(80 - (scrollProgress * 50), -10) // Mobile: slower movement (reduced from 100 to 50)
    : Math.max(40 - (scrollProgress * 30), -10)  // Desktop: slower movement (reduced from 60 to 30)
    ...
    >
      ...
      >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-gray-400 text-lg sm:text-xl leading-relaxed font-grotesk">
                Dynamic full-stack web developer with a proven track record at Tegrand Infotech, delivering scalable applications and optimizing performance. Proficient in Django REST Framework and React.js, I excel in client collaboration and agile project management.
              </p>
        ...
        >
          ...
          <motion.a
            href="#contact"
            className="social-link group relative overflow-hidden bg-gradient-to-r from-cyan-500/20 to-cyan-600/20 backdrop-blur-lg border-2 border-cyan-400/60 rounded-xl px-8 py-5 transition-all duration-300 hover:border-cyan-300 hover:from-cyan-400/30 hover:to-cyan-500/30 no-underline shadow-2xl shadow-cyan-500/20"
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <div className="text-cyan-300 font-bold text-base uppercase tracking-wider mb-1">
                  Start Project
                </div>
                <div className="text-gray-200 text-sm font-grotesk font-medium">
                  Let's build something amazing
                </div>
              </div>
              <div className="text-cyan-300 text-3xl ml-6 group-hover:scale-125 transition-transform duration-300">
                <LuMail />
              </div>
            </div>
