          ...
          <div className="footer-links grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 sm:gap-8">
            <div className="footer-section">
              ...
              <div className="flex flex-col gap-1.5 sm:gap-2">
                <a href="#about" className="text-text-secondary no-underline transition-all duration-300 hover:text-primary hover:translate-x-1 text-xs sm:text-sm">About</a>
                <a href="#projects" className="text-text-secondary no-underline transition-all duration-300 hover:text-primary hover:translate-x-1 text-xs sm:text-sm">Projects</a>
                <a href="#contact" className="text-text-secondary no-underline transition-all duration-300 hover:text-primary hover:translate-x-1 text-xs sm:text-sm">Contact</a>
              </div>
            </div>
