  ...
  const experiences = [
    {
      ...
      description: "Coordinating multiple client projects, ensuring timely delivery and bridging communication between developers, designers, and clients.",
      achievements: ["Project Management", "Client Communication", "Team Coordination", "Agile Methodologies"]
    },
    {
      id: 2,
      ...
      description: "Building responsive, scalable web applications with React + Django REST Framework, developing full-stack features and ensuring optimal performance.",
      achievements: ["React.js", "Django", "REST APIs", "PostgreSQL"]
    },
    {
      id: 3,
    ...
    >
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <i className="fas fa-briefcase text-3xl text-dark"></i>
          </motion.div>
        ...
        >
          ...
          {experiences.map((experience, index) => (
            ...
            >
              ...
              {/* Timeline Content */}
              <motion.div 
                className={`timeline-content bg-glass backdrop-blur-xl p-4 sm:p-6 lg:p-8 rounded-2xl border border-white/10 relative transition-all duration-300 shadow-glass hover:shadow-liquid ${
                  index % 2 === 1 ? 'ml-0 mr-0 md:mr-[60%]' : 'ml-0 mr-0 md:ml-[60%]'
                }`}
